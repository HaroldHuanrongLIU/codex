...
/// EXPERIMENTAL - create a realtime WebRTC call from a local SDP offer.
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadRealtimeCallCreateParams {
    pub thread_id: String,
    /// SDP offer generated by a WebRTC RTCPeerConnection after configuring audio and the realtime
    /// events data channel.
    pub sdp: String,
    pub prompt: String,
    #[ts(optional = nullable)]
